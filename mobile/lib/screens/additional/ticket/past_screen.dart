...
class _PastScreenState extends State<PastScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (currentUser != null) {
      ...
      tickets = tickets.where((ticket) => ticket['active'] == 'false').toList();
    }
        ...
        ? getPaddingWidget(
            ...
            Column(
              ...
              children: [
                ...
                getVerSpace(28.h),
                getCustomFont("No Past Ticket Yet!", 20.sp, Colors.black, 1,
                          ...
                          children: [
                            ...
                            Expanded(
                              ...
                              child: Column(
                                ...
                                children: [
                                  getCustomFont(ticket['name']!, 18.sp,
                                      Colors.black, 1,
                                      fontWeight: FontWeight.w600,
                                      txtHeight: 1.5.h),
                                  getVerSpace(6.h),
                                  getCustomFont(ticket['date']!, 15.sp,
                                      greyColor, 1,
